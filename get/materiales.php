...
/**
 * @brief Obtiene materiales filtrados por un parámetro.
 *
 * Esta función busca materiales en la base de datos basados en el parámetro proporcionado.
 *
 * @param PDO $con Una instancia de la clase PDO para la conexión a la base de datos.
 * @return array Un array de materiales que cumplen con los criterios de búsqueda.
 */
...
function getMaterialesbyParam($param, $value, $con)
{
...
/**
 * @brief Obtiene materiales filtrados por parámetros.
 *
 * Esta función busca materiales en la base de datos basados en los parámetros proporcionados.
 *
 ...
 */
 ...
 function getMaterialesbyParams($parametros, $con)
 {
     // Verificar si tiene el parámetro order
